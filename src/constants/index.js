...
const counterItems = [
  { value: 21, suffix: "", label: "Edad actual." },
  { value: 2, suffix: "+", label: "Títulos Técnicos" },
  { value: 5, suffix: "+", label: "Diplomados Finalizados" },
  { value: 6, suffix: "", label: "Meses de Experiencia STEAM" },
];
